...
namespace Baseclass.Contrib.Nuget.Output.Build
{
    ...
    public class PackageRetrievalTask : ITask
    {
        ...
        public bool Execute()
        {
            ...
            var usedNugetPackages = nugetPackages.Select(path => new TaskItem(path)).ToArray(); // list of nuget packages used by the project
        ...
        private void ReadUserPackagesFromXml(string packageConfigPath, HashSet<string> usedPackages, string elementName,
            string idAttributeName, string versionAttributeName)
        {
